      ...
      <div className="tutorial-grid">
            ...
            {expandedStep !== 2 ? (
              ...
              <div style={{ marginTop: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1rem', animation: 'fadeIn 0.5s ease forwards' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.8rem' }}>
                  ...
                  <p style={{ color: 'var(--text-color)', fontSize: '0.95rem' }}><b>Use the extension</b> to automatically capture and organize tabs without leaving your page.</p>
                </div>
              </div>
            )}
          </div>  
        ...
        <div className="tutorial-video" style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}>
            ...
            <iframe 
              width="100%" 
              height="100%" 
              style={{ objectFit:'fill',aspectRatio: '16/9', borderRadius: '8px', border: 'none' }}
